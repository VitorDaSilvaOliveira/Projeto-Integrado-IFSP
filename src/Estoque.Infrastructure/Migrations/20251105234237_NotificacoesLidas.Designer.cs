...
namespace Estoque.Infrastructure.Migrations
{
    ...
    [Migration("20251105234237_NotificacoesLidas")]
    partial class NotificacoesLidas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Estoque.Domain.Entities.MasterData", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(64)
            ...
            modelBuilder.Entity("Estoque.Domain.Entities.PedidoNFView", b =>
                {
                    ...
                    b.ToView("vw_PedidoNF", (string)null);
                });
            ...
            modelBuilder.Entity("Estoque.Domain.Entities.UserSetting", b =>
                {
                    ...
                    b.Property<bool>("EnableDarkModeSwitch")
                        .HasColumnType("bit");

                    b.Property<bool>("EnableLanguageSwitch")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Estoque.Domain.Entities.Produto", b =>
                {
                    b.HasOne("Estoque.Domain.Entities.Categoria", "Categoria")
                        .WithMany()
