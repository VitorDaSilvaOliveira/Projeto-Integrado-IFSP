...
\begin{itemize}
  ...
  \item \textbf{SQL Server}: Sistema gerenciador de banco de dados relacional utilizado para armazenar e manipular os dados da aplicação, com suporte a procedimentos, segurança e escalabilidade.
