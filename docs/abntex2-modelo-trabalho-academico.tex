...
\begin{itemize}
    ...
    \item \textbf{SMR (Scrum Master Representative)}: 
    Atua como facilitador do processo ágil, removendo obstáculos para que a equipe possa seguir com seu trabalho de forma eficiente. Ele ajuda na aplicação das práticas do Scrum e garante que todos os membros da equipe estejam alinhados com os objetivos e com a execução dos sprints.
