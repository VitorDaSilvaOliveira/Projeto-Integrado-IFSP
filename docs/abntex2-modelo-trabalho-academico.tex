...
\begin{figure}[h!]
    ...
    \caption{QR Code para a aplicação}
\end{figure}

\begin{center}
    \href{https://ifspestoque.azurewebsites.net/}{https://ifspestoque.azurewebsites.net/}
\end{center}
...
A viabilidade financeira do projeto foi feita através de uma simulação de possíveis custos da mão de obra, baseado na experiência dos integrantes, e nas horas efetivamente trabalhadas, além de custos operacionais.

\section{Custos}

A primeira tabela apresenta uma análise detalhada dos custos de desenvolvimento, com foco no investimento em mão de obra, que representa o principal ativo do projeto. A metodologia de cálculo é simples e transparente: o esforço previsto (em horas) é multiplicado pela taxa horária específica de cada especialista (desenvolvedores, analistas, gestores), garantindo uma apuração precisa e fiel aos valores de mercado.
