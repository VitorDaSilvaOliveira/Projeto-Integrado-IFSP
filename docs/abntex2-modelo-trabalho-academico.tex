...
Para garantir a máxima eficiência e colaboração, a equipe foi organizada conforme as habilidades e experiências específicas de cada membro da equipe. Essa abordagem assegurou que todos pudessem contribuir significativamente para o desenvolvimento e o sucesso do projeto.
...
\subsection{Back-end}
\begin{itemize}
	\item  \textbf{C\#}: É uma linguagem de programação moderna e multiparadigma desenvolvida pela Microsoft para a plataforma .NET, orientada a objetos. Ela é a linguagem principal da plataforma .NET, um ambiente de desenvolvimento gratuito, multiplataforma e de código aberto 
	\cite{microsoft_csharp_overview}.
\end{itemize}

\begin{itemize}
    \item \textbf{AS.NET}: Framework desenvolvido pela Microsoft, e utilizado para a criação de aplicações web robustas, seguras e escaláveis \cite{AspNet2025}.
\end{itemize}
...
\subsection{Custos}
O detalhamento dos custos de desenvolvimento apresentado na tabela 2 reflete os investimentos necessários em mão de obra para o projeto. Dividido em diferentes perfis técnicos, o esforço estimado para cada função é expresso em horas e dias de trabalho. Os valores correspondentes à mão de obra total, calculados com base na multiplicação do esforço estimado pela taxa horária de cada perfil, oferecem uma visão clara dos custos associados a cada etapa do desenvolvimento. Além disso, a duração total do projeto, estabelecida em 9 meses, permite uma análise mais abrangente dos custos mensais e totais de mão de obra, facilitando o planejamento financeiro e a gestão de recursos do projeto.
\begin{table}[h]
\centering
\caption{Detalhamento dos Custos de Desenvolvimento}
\label{tab:custos-desenvolvimento}
\begin{tabular}{|l|c|c|c|c|c|}
\hline
\textbf{Função} & \textbf{Esforço} & \textbf{Valor MO} & \textbf{Nível} & \textbf{Qtde} & \textbf{Horas/Dias} \\ \hline
Product Owner (PO) & Total & R\$ 27.000 & Júnior & 1 & 1.080h/180d \\ \hline
DBA & Total & R\$ 23.760 & Júnior & 1 & 1.080h/180d \\ \hline
Desenvolvedor Front-end & Total & R\$ 19.440 & Júnior & 1 & 1.080h/180d \\ \hline
Desenvolvedor Back-end & Total & R\$ 43.200 & Júnior & 2 & 2.160h/180d \\ \hline
Especialista em SI & Total & R\$ 24.840 & Júnior & 1 & 1.080h/180d \\ \hline
QA (Testes) & Total & R\$ 17.280 & Júnior & 1 & 1.080h/180d \\ \hline
\end{tabular}
...
Custo MO total: & R\$ 155.520 \\
Custo MO mensal: & R\$ 17.280 (custo total/duração) \\
\end{tabular}
...
\label{tab:estrutura-mensal}
\begin{tabular}{lcr}
\toprule
\textbf{Item} & \textbf{Quantidade} & \textbf{Valor (R\$)} \\
\midrule
2. Estrutura da empresa (mensal) & & \\
2.1. Instalações - Aluguel (espaço e mobiliário) & -- & R\$ 0 \\
2.2. Equipamentos (TI e Outros) $\rightarrow$ Aquisição & & \\
\quad $\bullet$ Computadores/notebooks & 0 & R\$ 0 \\
\quad $\bullet$ Servidores proprietários & 0 & R\$ 0 \\
\quad $\bullet$ Outros (mobiliário, etc.) & 0 & R\$ 0 \\
2.3. Serviços de TI & & \\
\quad $\bullet$ Ferramentas de desenvolvimento & -- & R\$ 0 \\
\quad $\bullet$ Hospedagem e banco de dados & -- & R\$ 0 \\
\midrule
\textbf{Total mensal} & & \textbf{R\$ 0} \\
\bottomrule
\end{tabular}
\fonte{Elaborado pelos autores}
...
% Cenário Realista
\centering
\caption{Cenário realista: ponto de equilíbrio em 15 meses (investimento inicial R\$ 155.520; receita mensal média R\$ 30.600)}
\fonte{Elaborado pelos autores}

% Cenário Otimista
\centering
\caption{Cenário otimista: ponto de equilíbrio em 12 meses (receitas 25\% acima do projetado)}
\fonte{Elaborado pelos autores}

% Cenário Pessimista
\centering
\caption{Cenário pessimista: ponto de equilíbrio em 20 meses (receitas 20\% abaixo do projetado)}
\fonte{Elaborado pelos autores}
